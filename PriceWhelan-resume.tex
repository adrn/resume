...
\documentclass[letterpaper,12pt]{deedy-resume}
...
\namesection{}{Adrian Price-Whelan, Ph.D.}{ % Your name profile or other web address
    {\large \color{black} astrophysicist \spacebar data scientist \spacebar musician \hspace{1em} (he/him)} \\
    \vspace{0.2em}
    {\normalsize
        ...
        \faEnvelope \, \href{mailto:adrianmpw@gmail.com}{adrianmpw@gmail.com}
        % \spacedot
...
\begin{tightitemize}
    ...
    % \item Presents research at invited talks and communicates astrophysics to public audiences through public outreach.
\end{tightitemize}

\sectionspace % Some white space after the section

\runsubsection{Simons Foundation}
\descript{| asst. director of scientific software}

\location{September 2022 – present | New York, NY}
% \vspace{1.5\topsep} % Hacky fix for awkward extra vertical space
\begin{tightitemize}
...
% \vspace{1.5\topsep} % Hacky fix for awkward extra vertical space
\begin{tightitemize}
    % \item Supervised undergraduate \& graduate students.
    % and strives to foster a communicative and supportive community.
...
% \vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightitemize}
    \item Lecturer for numerous software, computing, and data science workshops, including the LSSTC Data Science Fellowship program.
    % \item PyData NYC: half-day workshop
    % \item Lecturer for graduate student Data Science \& Machine Learning course at Princeton University
